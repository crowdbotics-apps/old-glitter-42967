"""
Django settings for old_glitter_42967 project.
...
ROOT_URLCONF = 'old_glitter_42967.urls'
...
WSGI_APPLICATION = 'old_glitter_42967.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "old_glitter_42967 API",
    "DESCRIPTION": "API documentation for old_glitter_42967 App",
    "VERSION": "v1",
}
